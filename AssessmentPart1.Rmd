...
LeedsMapOA <- read_shape("D:\\GIS\\datas\\Leeds_CDRC_2011_CensusGeodatapack\\shapefiles\\Leeds_oa11.shp", as.sf = TRUE)
```
...
```{r}
#join the data from census to the in the Leeds data frame
LeedsDataMapOA <- append_data(LeedsMapOA,LeedsData, key.shp = "OA11CD", key.data = "GeographyCode", ignore.duplicates = TRUE)
```
